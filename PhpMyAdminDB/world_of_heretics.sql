...
(2, 'omarinho', 0, 150, 5, 2, 45, 15),
(3, 'omar; select * from character;', 0, 150, 5, 2, 45, 15),
(4, 'drop table character;', 0, 150, 5, 2, 45, 15),
(5, 'omarinhohohoh', 4152, 300, 373, 2, 26, 12),
(6, 'Merlin', 0, 125, 5, 3, 45, 15);
...
--
-- Dumping data for table `character_to_item`
--

INSERT INTO `character_to_item` (`character_id`, `item_id`) VALUES
(5, 10),
(5, 11),
(5, 12),
(5, 13),
